...
var MomoPayment = /** @class */ (function () {
    ...
    MomoPayment.prototype.createPayment = function (input) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var url, signatureRaw, signature, data, res, e_1;
                ...
                switch (_f.label) {
                    case 0:
                        ...
                        signatureRaw = "accessKey=" +
                            ...
                            input.amount +
                            "&extraData=" +
                            ((_a = input.extraData) !== null && _a !== void 0 ? _a : "") +
                            "&ipnUrl=" +
                            input.ipnUrl +
                            "&orderId=" +
                            input.orderId +
                            ...
                            input.requestId +
                            "&requestType=" +
                            ((_b = input.requestType) !== null && _b !== void 0 ? _b : "captureWallet");
                        signature = crypto
                        ...
                        data = {
                            ...
                            ipnUrl: input.ipnUrl,
                            extraData: (_c = input.extraData) !== null && _c !== void 0 ? _c : "",
                            requestType: (_d = input.requestType) !== null && _d !== void 0 ? _d : "captureWallet",
                            signature: signature,
                            lang: (_e = input.lang) !== null && _e !== void 0 ? _e : "en",
                        };
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        data = JSON.stringify({
                            ...
                            lang: (_a = input.lang) !== null && _a !== void 0 ? _a : "en",
                            signature: signature,
                        });
                        return [4 /*yield*/, (0, axios_1.default)({
                                method: "POST",
